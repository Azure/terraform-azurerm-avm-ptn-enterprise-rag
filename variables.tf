...
variable "resource_name_templates" {
  ...
  default = {
    ...
    document_storage_account_name          = "st$${workload}$${environment}$${location_short}$${sequence}$${uniqueness}"
    ...
    orchestrator_storage_account_name      = "stfnorch$${workload}$${environment}$${location_short}$${sequence}"
    data_ingestion_function_app_name       = "fn-ingest-$${workload}-$${environment}-$${location}-$${sequence}"
    data_ingestion_storage_account_name    = "stfningest$${workload}$${environment}$${location_short}$${sequence}"
